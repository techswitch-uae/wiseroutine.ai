...
| Activity planning | Duration-aware frequency and save/reload; repeated activities spread across Today; future-only pointer/keyboard movement; full-day shortfalls survive reload and can be placed manually | Shared scheduler rules plus Worker/database integration; see [activity planning](activity-planning.md) |
...
browser projects), **30 web unit cases**, and **49 full-stack app scenarios**.
