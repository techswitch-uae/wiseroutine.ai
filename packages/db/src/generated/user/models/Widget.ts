...
export type WidgetWhereInput = {
  ...
  widgetKey?: Prisma.StringFilter<"Widget"> | string
  position?: Prisma.IntFilter<"Widget"> | number
  isEnabled?: Prisma.BoolFilter<"Widget"> | boolean
}
...
export type WidgetScalarWhereWithAggregatesInput = {
  ...
  widgetKey?: Prisma.StringWithAggregatesFilter<"Widget"> | string
  position?: Prisma.IntWithAggregatesFilter<"Widget"> | number
  isEnabled?: Prisma.BoolWithAggregatesFilter<"Widget"> | boolean
}
...
export type WidgetOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"widgetKey" | "position" | "isEnabled", ExtArgs["result"]["widget"]>
...
export interface WidgetDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `widgetKey`
   * const widgetWithWidgetKeyOnly = await prisma.widget.findMany({ select: { widgetKey: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Widgets and only return the `widgetKey`
   * const widgetWithWidgetKeyOnly = await prisma.widget.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more Widgets and only return the `widgetKey`
   * const widgetWithWidgetKeyOnly = await prisma.widget.updateManyAndReturn({
   *   select: { widgetKey: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface WidgetFieldRefs {
  readonly widgetKey: Prisma.FieldRef<"Widget", 'String'>
  readonly position: Prisma.FieldRef<"Widget", 'Int'>
  readonly isEnabled: Prisma.FieldRef<"Widget", 'Boolean'>
}
